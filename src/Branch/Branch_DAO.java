...
public class Branch_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try { 
         con = getCon();
         String sql = "select * from Branch order by Lnum asc"; //sql 문
   ...
   public boolean insert(Branch_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into Branch(" +"Lnum,Bname,Blocation)" +"values(?,?,?)";//sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(int Lnum) {
      ...
      try {
         con = getCon();
         String sql = "delete from Branch where Lnum=?";//sql 문
   ...
   public boolean update(Branch_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update Branch set Bname=? , Blocation=? " + "where Lnum=?";//sql 문
         ps = con.prepareStatement(sql);
