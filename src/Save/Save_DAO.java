...
public class Save_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try { 
         con = getCon();
         String sql = "select * from Save order by Snum asc"; //sql 문
   ...
   public boolean insert(Save_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into Save(" +"Snum,Samount,Stype,Acnum)" +"values(?,?,?,?)";//sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(int Snum) {
      ...
      try {
         con = getCon();
         String sql = "delete from Save where Snum=?";//sql 문
   ...
   public boolean update(Save_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update Save set Samount=? , Stype=? , Acnum=? " + "where Snum=?";//sql 문
         ps = con.prepareStatement(sql);
