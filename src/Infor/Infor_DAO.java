...
public class Infor_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try { 
         con = getCon();
         String sql = "select * from Infor order by Cname asc"; //sql 문
   ...
   public boolean insert(Infor_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into Infor(" +"cname,phone,address)" +"values(?,?,?)";//sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(String Cname) {
      ...
      try {
         con = getCon();
         String sql = "delete from Infor where Cname=?";//sql 문
   ...
   public boolean update(Infor_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update infor set phone=? , address=? " + "where Cname=?";//sql 문
         ps = con.prepareStatement(sql);
