...
public class Infor_Panel extends JFrame implements ActionListener {
	public JPanel contentPane;
	public Connection con = null;
	private String colName[] = { "고객 이름", "전화 번호" ,"주 소"};
	...
	public Infor_Panel() {
		...
		JLabel lblNewLabel = new JLabel("Infor");
	...
	//각각의 버튼에서 Source를 가져와 생성자 호출
		   public void actionPerformed(ActionEvent e) {
		      if(e.getSource() == insert) {
		         ...
		         new Infor_UpdateDialog();
		      }
		      else if(e.getSource() == delete) {
		         new Infor_DeleteDialog();
		      }
