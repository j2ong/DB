...
public class Partner_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try { 
         con = getCon();
         String sql = "select * from Partner order by Canum asc"; //sql 문
   ...
   //Insert 함수
   public boolean insert(Partner_DTO dto) {
      boolean ok = false;
      Connection con = null;
      PreparedStatement ps = null;
      ...
      try {
         con = getCon();
         String sql = "insert into Partner(" +"Canum,Pname,Disrate)" +"values(?,?,?)";//sql 문
         ps = con.prepareStatement(sql);
         ps.setInt(1, dto.getCanum());
         ps.setString(2, dto.getPname());
         ps.setString(3, dto.getDisrate());
   ...
   public boolean delete(int Canum) {
      ...
      try {
         con = getCon();
         String sql = "delete from Partner where Canum=?";//sql 문
   ...
   //UPDATE
   public boolean update(Partner_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update Partner set Pname=? , Disrate=? " + "where Canum=?";//sql 문
         ps = con.prepareStatement(sql);
         ps.setString(1, dto.getPname());
         ps.setString(2, dto.getDisrate());
