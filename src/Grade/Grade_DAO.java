...
public class Grade_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try { 
         con = getCon();
         String sql = "select * from Grade order by Cunum asc"; //sql 문
   ...
   public boolean insert(Grade_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into Grade(" +"cunum,Acnum,grade)" +"values(?,?,?)";//sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(int Cunum) {
      ...
      try {
         con = getCon();
         String sql = "delete from Grade where Cunum=?";//sql 문
   ...
   public boolean update(Grade_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update Grade set Acnum=? , Grade=? " + "where Cunum=?";//sql 문
         ps = con.prepareStatement(sql);
