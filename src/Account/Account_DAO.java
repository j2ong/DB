...
public class Account_DAO {		//데이터베이스에 접근하는 객체
   ...
   public void select(DefaultTableModel model) {
      ...
      try {
         con = getCon();
         String sql = "select * from Account order by Acnum asc"; //sql 문
   ...
   public boolean insert(Account_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into Account(" +"Acnum,Balance)" +"values(?,?)"; //sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(String Acnum) {
      ...
      try {
         con = getCon(); 
         String sql = "delete from Account where Acnum=?"; //sql 문
   ...
   public boolean update(Account_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update Account set Balance=? " + "where Acnum=?"; //sql 문
