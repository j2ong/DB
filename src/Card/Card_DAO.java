...
public class Card_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try { 
         con = getCon();
         String sql = "select * from Card order by Canum asc"; //sql 문
   ...
   public boolean insert(Card_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into Card(" +"Canum,Acnum,Ctype)" +"values(?,?,?)";//sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(int Canum) {
      ...
      try {
         con = getCon();
         String sql = "delete from Card where Canum=?";//sql 문
   ...
   public boolean update(Card_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update Card set Acnum=? , Ctype=? " + "where Canum=?";//sql 문
         ps = con.prepareStatement(sql);
