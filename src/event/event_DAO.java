...
public class event_DAO {
   ...
   public void select(DefaultTableModel model) {
      ...
      try {
         con = getCon();
         String sql = "select * from event order by cunum"; //sql 문
   ...
   public boolean insert(event_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "insert into event(" +"enum,cunum)" +"values(?,?)";//sql 문
         ps = con.prepareStatement(sql);
   ...
   public boolean delete(int Enum) {
      ...
      try {
         con = getCon();
         String sql = "delete from event where enum=?";//sql 문
   ...
   public boolean update(event_DTO dto) {
      ...
      try {
         con = getCon();
         String sql = "update event set Cunum=? " + "where enum=?";//sql 문
